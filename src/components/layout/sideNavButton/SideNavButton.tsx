...
const SideNavButton = ({ children, href, name, disable }: sideBtnType) => {
  ...
  return (
    <>
      ...
      >
        ...
        {message && (
          <p className="absolute med:right-[30px] right-2 text-white bg-mutedRed rounded-full w-[18px] h-[18px] center text-xs font-normal">
            {number}
          </p>
        )}
      </li>
